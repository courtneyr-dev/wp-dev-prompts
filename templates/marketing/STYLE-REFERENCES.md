# Marketing Content Style References
...
1. **Anti-Patterns** (highest priority) — What to avoid
2. **WordPress Documentation Style Guide** — Official WordPress standards
3. **Personal Style Guide** — Voice and tone preferences
...
### Blog Posts (`BLOG-POST-LAUNCH-TEMPLATE.md`)
...
### Email Sequences (`EMAIL-SEQUENCE-TEMPLATE.md`)
...
### Social Media (`SOCIAL-MEDIA-CALENDAR-TEMPLATE.md`)
...
### Press Releases (`PRESS-RELEASE-TEMPLATE.md`)
...
### Podcast Pitches (`PODCAST-PITCH-TEMPLATE.md`)
