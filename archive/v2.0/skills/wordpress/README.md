...
Core WordPress development patterns and APIs.

## Skills

| Skill | Description | Source |
|-------|-------------|--------|
| [plugin-architecture.md](plugin-architecture.md) | Plugin structure, hooks, and best practices | wp-dev-prompts |
| [plugin-core.md](plugin-core.md) | Security-first plugin development for WP 6.7+ | [jezweb](https://skills.sh/jezweb/claude-skills/wordpress-plugin-core) |
| [block-development.md](block-development.md) | Gutenberg block creation | wp-dev-prompts |
| [block-themes.md](block-themes.md) | Block theme development | wp-dev-prompts |
| [interactivity-api.md](interactivity-api.md) | WordPress Interactivity API | wp-dev-prompts |
...
Reference these skills when working on WordPress development:
...
- [Security Skills](../security/) - Input validation, escaping, nonces
- [Testing Skills](../testing/) - PHPUnit, PHPCS, Playwright
